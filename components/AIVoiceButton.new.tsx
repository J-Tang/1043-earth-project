...
export default function AIVoiceButton({ 
  ...
  return (
    <div className={`${fullScreen ? 'min-h-screen bg-gradient-to-br from-gray-900 to-black' : 'fixed inset-0 z-[9999] bg-black/95 backdrop-blur-lg'} flex flex-col items-center justify-center p-4`}>
      {/* 关闭按钮（非全屏模式显示） */}
      {!fullScreen && (
        <button
          onClick={handleClose}
